...
Devise.setup do |config|
  ...
  config.mailer_sender = "galo.gimenez@gmail.com"
  ...
  config.omniauth :facebook, "204674789573514", "1231e834c6a78af3ad6b04fb7cf97330"
  #config.omniauth :twitter, "0d9QC8DYESVnBS1nNS8A", "6r1JMN8hBovVW6oHEetiaCH68LTTuTBsYDO4sX1X3Y"
  config.omniauth :google_apps, OpenID::Store::Filesystem.new('/tmp'), :domain => 'gmail.com'
  #config.omniauth :linked_in, "cpasLAfk4wEukfZpAMokoqBsTOIzNMmk30TwYe5x7HugW8iw2HMIYoheMXqfywTr", "JYxb9sSfNmNQty188lT0bZMO0vT2t83b4fJRPDPcnmrAjosCE-IqsTk6DCHP9G8I"

  
  # config.warden do |manager|
  #   manager.oauth(:twitter) do |twitter|
  #     twitter.consumer_secret ="0dBUYp3z0ZDRXSz6ZR4pPuzzQqTMpGuhJQiiIB0hfE"
  #     twitter.consumer_key  = "7TyeBhNoZd4fbDtqTn8IQ"
